      ...
      <div class="container z-fix">
        <div class="row">
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="mt-3">
              <a class="btn btn-primary btn-cta bg-red text-white mr-2 p-3 font-weight-bold" style="background-color: #ec361f;border-color: #ec361f;" href="{{ route('feed') }}" role="button">@lang('landing.get-started')</a>
            </div>
          </div>
