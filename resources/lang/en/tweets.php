...
return [
    ...
    [
        ...
        'body' =>[
            [
                ...
                'The link is ' . generate_and_cache_shlink('https://veganbootcamp.org') . ';',
                'The URL is ' . generate_and_cache_shlink('https://veganbootcamp.org') . ';',
                'The site is at ' . generate_and_cache_shlink('https://veganbootcamp.org') . ';',
                'The website is ' . generate_and_cache_shlink('https://veganbootcamp.org') . ';',
            ], [
    ...
    [
        ...
        'body' =>[
            [
                ...
                'Beyond Meat is really good: ' . generate_and_cache_shlink('https://www.beyondmeat.com/') . ', and Gardein also has a ton of products: ' . generate_and_cache_shlink('https://www.gardein.com/') . ' Take a look around your grocery store to see what\'s available, you might be surprised!'
            ]
        ]
    ],
    ...
    [
        ...
        'body' =>[
            [
                'Here are some movies for motivation! Cowspiracy \(Environment\): ' . generate_and_cache_shlink('https://www.netflix.com/title/80033772') . ' The Game Changers \(Health\): ' . generate_and_cache_shlink('https://www.netflix.com/title/81157840') . ' Dominion \(Animals\): ' . generate_and_cache_shlink('https://youtu.be/ny6aqdFy9SI?t=43') . '\.'
            ], [
